...
*Scripts*
  ...
  - `ipm_vital_rate_parameter_analysis.R`: Fits models and performs model comparison to determine the vital rate function parameters used for the Bd-Rana muscosa IPM. This script saves the parameters in a RDS file for later use. **This is the first script that needs to be run for the analysis**.
  ...
  - `run_all.R`: Runs all scripts in the appropriate order
